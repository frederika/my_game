...
img_back = "фон гри.jpg"  # фон гри
img_hero = "kitti.png"  # герой
img_bullet = "кр.jpg" # куля
img_enemy = "кіті зомбі 2.png"  # ворог
 
score = 0  # збито кораблів
goal = 30 # стільки кораблів потрібно збити для перемоги
...
win_width = 700
win_height = 500
display.set_caption("Hello Kitty")
...
for i in range(1, 6):
    monster = Enemy(img_enemy, randint(
        80, win_width - 80), -40, 80, 80, randint(1, 5))
